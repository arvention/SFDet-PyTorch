...
class SFDetV2EfficientNetV2(nn.Module):
    ...
    def __init__(self,
        ...
        super(SFDetV2EfficientNetV2, self).__init__()
        self.mode = mode
        self.base = base
...
def build_SFDetV2EfficientNetV2(mode,
                                new_size,
    ...
    if pretrained_model is not None:
        head = multibox(input_size=new_size // 8,
                        class_count=81)
        model = SFDetV2EfficientNetV2(mode=mode,
                                      base=base,
